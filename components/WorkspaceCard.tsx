...
export default function WorkspaceCard({
  ...
  return (
    <li className="col-span-1 divide-y divide-gray-200 rounded-lg bg-white shadow transition-transform duration-200 hover:scale-105 dark:bg-gray-800 dark:divide-gray-700">
      <Link href={`/space/${id}`} className="block h-full">
        <div className="flex w-full items-center justify-between space-x-6 p-6 h-full">
